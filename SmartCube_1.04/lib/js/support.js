function supportjs() {
    ...
    this.craftChecker = {
        checkEach: function (){
            ...
            if (this.objects.length == 0 && this.group.children.length > 0){
        ...
        remove: function (object){
            ...
            //this.group.children.splice(this.group.children.indexOf(object),1);
    ...
    this.getMaps = function (name) {
        if (this.textureStorage[name] !=undefined) {
            ...
            //this.textureStorage[name].format = THREE.RGBAFormat;
            return this.textureStorage[name];
        }
    };
    ...
    //
        ...
        //     return c;
        // }
    this.controlCamera = function () {//An Object
        var scope = this;
        ...
        this.rotate = function (mx,my) {
            ...
            players[0].face.y = yawObject.rotation.y;
            players[0].face.x = pitchObject.rotation.x;
        }
    ...
    this.startWalkW = function (num) {
        if (players[num].isWalking.W == false) {
            ...
            players[num].cycles.W[players[num].cycles.W.length] = window.setInterval(function () {
                var face = players[num].face.y;
                if (Math.sin(face) > 0) {
                    if (anl.getType(map.data[0|(players[num].position.z + 0.7)][0|(players[num].position.x + 0.3 - players[num].speedXZ * Math.sin(face))][0|(players[num].position.y + 0.000001)].name) != "hard" && anl.getType(map.data[0|(players[num].position.z + 0.3)][0|(players[num].position.x + 0.3 - players[num].speedXZ * Math.sin(face))][0|(players[num].position.y + 0.000001)].name) != "hard") {
                        controlCamera.getObject().position.x = players[num].position.x -= players[num].speedXZ * Math.sin(face);
                    }
                } else if (Math.sin(face) < 0) {
                    if (anl.getType(map.data[0|(players[num].position.z + 0.7)][0|(players[num].position.x + 0.7 - players[num].speedXZ * Math.sin(face))][0|(players[num].position.y + 0.000001)].name) != "hard" && anl.getType(map.data[0|(players[num].position.z + 0.3)][0|(players[num].position.x + 0.7 - players[num].speedXZ * Math.sin(face))][0|(players[num].position.y + 0.000001)].name) != "hard") {
                        controlCamera.getObject().position.x = players[num].position.x -= players[num].speedXZ * Math.sin(face);
                    }
                }
                if (Math.cos(face) > 0) {
                    if (anl.getType(map.data[0|(players[num].position.z + 0.3 - players[num].speedXZ * Math.cos(face))][0|(players[num].position.x + 0.3)][0|(players[num].position.y + 0.000001)].name) != "hard" && anl.getType(map.data[0|(players[num].position.z + 0.3 - players[num].speedXZ * Math.cos(face))][0|(players[num].position.x + 0.7)][0|(players[num].position.y + 0.000001)].name) != "hard") {
                        controlCamera.getObject().position.z = players[num].position.z -= players[num].speedXZ * Math.cos(face);
                    }
                } else if (Math.cos(face) < 0) {
                    if (anl.getType(map.data[0|(players[num].position.z + 0.7 - players[num].speedXZ * Math.cos(face))][0|(players[num].position.x + 0.3)][0|(players[num].position.y + 0.000001)].name) != "hard" && anl.getType(map.data[0|(players[num].position.z + 0.7 - players[num].speedXZ * Math.cos(face))][0|(players[num].position.x + 0.7)][0|(players[num].position.y + 0.000001)].name) != "hard") {
                        controlCamera.getObject().position.z = players[num].position.z -= players[num].speedXZ * Math.cos(face);
                    }
                }
            },players[num].speed);
    ...
    this.startWalkS = function (num) {
        if (players[num].isWalking.S == false) {
            ...
            players[num].cycles.S[players[num].cycles.S.length] = window.setInterval(function () {
                var face = players[num].face.y + Math.PI;
                if (Math.sin(face) > 0) {
                    if (anl.getType(map.data[0|(players[num].position.z + 0.7)][0|(players[num].position.x + 0.3 - players[num].speedXZ * Math.sin(face))][0|(players[num].position.y + 0.000001)].name) != "hard" && anl.getType(map.data[0|(players[num].position.z + 0.3)][0|(players[num].position.x + 0.3 - players[num].speedXZ * Math.sin(face))][0|(players[num].position.y + 0.000001)].name) != "hard") {
                        controlCamera.getObject().position.x = players[num].position.x -= players[num].speedXZ * Math.sin(face);
                    }
    ...
    this.startWalkA = function (num) {
        if (players[num].isWalking.A == false) {
            ...
            players[num].cycles.A[players[num].cycles.A.length] = window.setInterval(function () {
                var face = players[num].face.y + Math.PI/2;
                if (Math.sin(face) > 0) {
                    if (anl.getType(map.data[0|(players[num].position.z + 0.7)][0|(players[num].position.x + 0.3 - players[num].speedXZ * Math.sin(face))][0|(players[num].position.y + 0.000001)].name) != "hard" && anl.getType(map.data[0|(players[num].position.z + 0.3)][0|(players[num].position.x + 0.3 - players[num].speedXZ * Math.sin(face))][0|(players[num].position.y + 0.000001)].name) != "hard") {
                        controlCamera.getObject().position.x = players[num].position.x -= players[num].speedXZ * Math.sin(face);
                    }
    ...
    this.checkPlayer = function (num) {
        if (0|(players[num].position.y + players[num].speedY/20) < 0 || 0|(players[num].position.y + 1) >= map.data[0|(players[num].position.z + 0.5)][0|(players[num].position.x + 0.5)].length) {
            //Player Has Died...
        } else {
            if (players[num].walking == true) {
                if (players[num].speedXZ < 0.05) {
                    players[num].speedXZ += 0.001;
                }
            } else {
                players[num].speedXZ = 0;
            }
            if (anl.getType(map.data[0|(players[num].position.z + 0.7)][0|(players[num].position.x + 0.7)][0|(players[num].position.y -0.001 + players[num].speedY*control.checkSpeed/1000)].name) != "hard" && anl.getType(map.data[0|(players[num].position.z + 0.3)][0|(players[num].position.x + 0.3)][0|(players[num].position.y -0.001 + players[num].speedY*control.checkSpeed/1000)].name) != "hard") {
                players[num].position.y += players[num].speedY*control.checkSpeed*0.001;
                if (players[num].speedY > - 40) {
                    players[num].speedY -= control.gravity*control.checkSpeed*0.001;
                }
                controlCamera.getObject().position.y = players[num].position.y + 1;
            } else {
                ...
                // players[num].position.y += players[num].speedY/20;
                players[num].position.y = 0|(players[num].position.y + 0.000001);
                controlCamera.getObject().position.y = players[num].position.y + 1;
            }
        }
    };
    this.jump = function (num) {
        if (players[num].isWalking.Space == false) {
            ...
            players[num].cycles.Space[players[num].cycles.Space.length] = window.setInterval(function () {
                if (anl.getType(map.data[0|(players[num].position.z + 0.7)][0|(players[num].position.x + 0.7)][0|(players[num].position.y + 2.6)].name) != "hard" && anl.getType(map.data[0|(players[num].position.z + 0.3)][0|(players[num].position.x + 0.3)][0|(players[num].position.y + 2.6)].name) != "hard" && players[num].speedY <= 0) {
                    if (anl.getType(map.data[0|(players[num].position.z + 0.7)][0|(players[num].position.x + 0.7)][0|(players[num].position.y -0.4)].name) == "hard" || anl.getType(map.data[0|(players[num].position.z + 0.3)][0|(players[num].position.x + 0.3)][0|(players[num].position.y -0.2)].name) == "hard"){
...
"</table>",
                    ...
                    if(e === true){
                        window.control = {
                            ...
                            sunCheckSpeed: 25,
                            gravity: eval(document.getElementById("gravity").innerText)
                        };
                        var seed = document.getElementById("mapSeed").innerText;
                        window.map = {
                        ...
                        localStorage.setItem("gravity",control.gravity);
