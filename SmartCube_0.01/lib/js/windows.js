function windowsjs() {
    ...
    this.game = function () {
        ...
        //初始化
            ...
            //场景与相机
                scene = new THREE.Scene();
                camera = new THREE.PerspectiveCamera(45, cavW/cavH , 0.1, 10000);
                            camera.position.x = 0;
                            camera.position.y = 0;
                            camera.position.z = 0;
                            camera.up.x = 0;
                ...
                controlCamera = new anl.controlCamera();
                controlCamera.getObject().position.x = players[0].rx = control.eyesight;
                controlCamera.getObject().position.y = (players[0].ry = 250) + 2;
                controlCamera.getObject().position.z = players[0].rz = control.eyesight;
            //光照
                // var light = new THREE.DirectionalLight(0xffffff,1.0);
            ...
            //天空球
				...
				sky = new THREE.Mesh( new THREE.BoxGeometry( control.eyesight*2 , 256 , control.eyesight*2 , 7, 7, 7 ), material );
				sky.scale.x = - 1;
            //放置
            ...
            //启动
                //循环
                    ...
                    cycles[cycles.length] = window.setInterval(this.cycle0,25);
                    cycles[cycles.length] = window.setInterval(this.cycle1,1000);
        ...
        this.cycle1 = function () {
            ...
            if (map.time <= 1000) {
                ...
                directionalLight.intensity = Math.sin(a) * 0.6;
                directionalLight1.intensity = Math.sin(a)/2 + 0.25;
                directionalLight2.intensity = Math.sin(a)/2 + 0.25;
                directionalLight3.intensity = Math.sin(a)/2 + 0.25;
                directionalLight4.intensity = Math.sin(a)/2 + 0.25;
